...
namespace sibr {
	...
	protected:
		...
		std::vector<int> anchor_level;
		std::vector<float> anchor_extra_level;
		...
		torch::Tensor ak_level_all;
		torch::Tensor ak_extra_level_all;
		...
		bool _splattingAll = true;
		bool _accumulatingLevels = true;
		bool _showingscale = false;
		int _splattingLevels = 0;
		GaussianData* gData;
